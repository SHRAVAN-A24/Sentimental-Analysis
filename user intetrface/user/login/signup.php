<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if( emptyInput($name,$email ,$Uname,$password,$rpassword ) !==false  )
		{
...
$id =	createuser($con,$name,$email,$Uname,$rpassword ,$adr,$ph );
	header( "Location: login.php?message=new_user_created" );
exit();
	}	
?>
<!DOCTYPE html>
